...
### 2.1 Stack de Métricas (Prometheus + Grafana) **Quique y Diego C.**
...
### 2.2 Centralización de Logs **Quique**
...
### 3.1 "El Búnker" (Nodo de Almacenamiento) **Uriel y Diego C.**
...
### 3.2 Estrategia de Backups Automatizados **Diego C. y Uriel**
